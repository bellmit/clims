...
/**
 * <p>ArrayOfMemberInfo complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="ArrayOfMemberInfo"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="MemberInfo" type="{http://domain.lims.viathink.com}MemberInfo" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "ArrayOfMemberInfo", namespace = "http://domain.lims.viathink.com", propOrder = {
    "memberInfo"
})
public class ArrayOfMemberInfo {

    @XmlElement(name = "MemberInfo", nillable = true)
