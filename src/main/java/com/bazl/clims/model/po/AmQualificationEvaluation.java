...
public class AmQualificationEvaluation {
    private String id;
    ...
    private String reviewCommitteeOpinion;
    ...
    public String getReviewCommitteeOpinion() {
        return reviewCommitteeOpinion;
    }

    public void setReviewCommitteeOpinion(String reviewCommitteeOpinion) {
        this.reviewCommitteeOpinion = reviewCommitteeOpinion == null ? null : reviewCommitteeOpinion.trim();
    }
