...
public class PageInfo {
	...
	private int evePageRecordCnt1 =  5;//每页记录数

	public int getEvePageRecordCnt1() {
		return evePageRecordCnt1;
	}

	public void setEvePageRecordCnt1(int evePageRecordCnt1) {
		this.evePageRecordCnt1 = evePageRecordCnt1;
	}
	...
	public PageInfo updatePageInfo1(long allRecordCount) {
		this.setAllRecordCount((int)allRecordCount);
		if(allRecordCount%evePageRecordCnt1==0){
			this.setPageCount((int)allRecordCount/evePageRecordCnt1);
		}else{
			this.setPageCount((int)allRecordCount/evePageRecordCnt1+1);
		}
