...
public class FtpUtils {
    ...
    public FtpUtils(String server, String port, String userName, String userPassword) {
        this.server = server;
        this.port = port;
    ...
    public static void main(String[] args) {
        //  FtpUtils f = new FtpUtils("192.168.176.129", 21, "uftp", "uftp");
        FtpUtils f = new FtpUtils("192.168.0.103", "21", "test", "test");
        try {
            if(f.open()) {
                String fileName = "2.txt";
                //上传
                f.upload("d:/11.txt", fileName, "file");

                //遍历
                FTPFile[] list = f.getFileList("file");
